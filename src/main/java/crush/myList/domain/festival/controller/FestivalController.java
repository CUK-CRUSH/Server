...
public class FestivalController {
    ...
    @GetMapping("/match")
    public JsonBody<FormData> matchGet(@RequestParam String id) {
        return JsonBody.of(200, "축제 매칭 신청 확인 성공", festivalService.matchGet(id));
    }
    ...
    @DeleteMapping("/match")
    public JsonBody<String> matchDelete(@RequestParam String id) {
        return JsonBody.of(200, "축제 매칭 신청 취소 성공", festivalService.matchDelete(id));
    }
}
